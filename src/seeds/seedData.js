  ...
  try {
    ...
    const bookings = await Booking.insertMany([
      ...
      },
      {
        ...
        status: "pending",
        paymentStatus: "pending",
        location: "555 Beach Resort, Miami",
        specialRequests: "Beach wedding photography",
      },
      {
        customer: customers[6]._id,
        artist: artists[1]._id,
        category: categories[1]._id,
        service: "Corporate DJ",
        ...
        status: "confirmed",
        paymentStatus: "paid",
        location: "888 Convention Center, Seattle",
        specialRequests: "Corporate event DJ services",
      },
      {
        customer: customers[7]._id,
        artist: artists[3]._id,
        category: categories[3]._id,
        service: "Mural Painting",
        bookingDate: new Date("2025-04-25"),
        startTime: "13:00",
        endTime: "17:00",
        duration: 4,
        totalAmount: 400,
        status: "completed",
        paymentStatus: "paid",
        location: "222 Community Center, Boston",
        specialRequests: "Mural painting for children's room",
      },
      {
        customer: customers[0]._id,
        artist: artists[4]._id,
        category: categories[4]._id,
        service: "Contemporary Dance",
        ...
        status: "pending",
        paymentStatus: "pending",
        location: "333 Dance Academy, New York",
        specialRequests: "Contemporary dance performance",
      },
      {
        customer: customers[1]._id,
        artist: artists[6]._id,
        ...
        bookingDate: new Date("2025-05-05"),
        startTime: "10:00",
        endTime: "16:00",
        duration: 6,
        totalAmount: 1080,
        status: "confirmed",
        paymentStatus: "paid",
        location: "444 Event Space, Los Angeles",
        specialRequests: "Corporate video production",
      },
      {
        customer: customers[2]._id,
        artist: artists[7]._id,
        ...
        status: "completed",
        paymentStatus: "paid",
        location: "666 Beauty Studio, Chicago",
        specialRequests: "Editorial makeup for photoshoot",
      },
      {
        customer: customers[3]._id,
        artist: artists[8]._id,
        ...
        status: "confirmed",
        paymentStatus: "paid",
        location: "777 Music Hall, Houston",
        specialRequests: "Jazz trio performance",
      },
      {
        customer: customers[4]._id,
        artist: artists[0]._id,
        ...
        status: "declined",
        paymentStatus: "pending",
        location: "999 Garden Venue, Phoenix",
        specialRequests: "Outdoor event photography",
      },
      {
        customer: customers[5]._id,
        artist: artists[2]._id,
        category: categories[2]._id,
        service: "Live Acoustic",
        bookingDate: new Date("2025-05-25"),
        startTime: "17:00",
        endTime: "19:00",
        duration: 2,
        totalAmount: 240,
        status: "completed",
        paymentStatus: "paid",
        location: "111 Restaurant, Miami",
        specialRequests: "Live acoustic performance",
      },
      {
        customer: customers[6]._id,
        artist: artists[1]._id,
        ...
        status: "pending",
        paymentStatus: "pending",
        location: "222 Nightclub, Seattle",
        specialRequests: "Electronic dance music set",
      },
      {
        customer: customers[7]._id,
        artist: artists[3]._id,
        ...
        status: "confirmed",
        paymentStatus: "pending",
        location: "333 Art Gallery, Boston",
        specialRequests: "Custom portrait painting",
      },
      {
        customer: customers[0]._id,
        artist: artists[6]._id,
        ...
        status: "confirmed",
        paymentStatus: "paid",
        location: "444 Wedding Venue, New York",
        specialRequests: "Full day wedding videography",
      },
      {
        customer: customers[1]._id,
        artist: artists[7]._id,
        ...
        status: "completed",
        paymentStatus: "paid",
        location: "555 Bridal Salon, Los Angeles",
        specialRequests: "Wedding day makeup and hair",
      },
      {
        customer: customers[2]._id,
        artist: artists[8]._id,
        category: categories[7]._id,
        service: "Smooth Jazz",
        bookingDate: new Date("2025-06-20"),
        startTime: "19:00",
        endTime: "22:00",
        duration: 3,
        totalAmount: 480,
        status: "cancelled",
        paymentStatus: "refunded",
        location: "666 Jazz Bar, Chicago",
        specialRequests: "Smooth jazz performance",
      },
    ]);
